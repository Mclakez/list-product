...
let cart = []
//i want localstorage to keep track of the items i added to cart,for thec quantity to be displayed instead of add to cart
...
function addToCart(name, price, quantity, image) {
    ...
    localStorage.setItem("added", JSON.stringify(cart))
